# Stock Sentiment with flaskSaas

## Configuration special

Insert your personal Twitter API and NewsAPI credentials in the model.py file in inside the "app" folder.
The rest of the configuration is described below in the original setup instructions

![License](http://img.shields.io/:license-mit-blue.svg)

This project relies heavily on a fork of [Max Halford's](https://github.com/MaxHalford) [flask-boilerplate](https://github.com/MaxHalford/flask-boilerplate).

This is a first attempt with very limited features.

THE OUTPUT MAY TAKE UP TO A MINUTE, DEPENDING ON THE CHOSEN STOCK (this part is not yet implemented dynamically)

currently there is a test account active:
